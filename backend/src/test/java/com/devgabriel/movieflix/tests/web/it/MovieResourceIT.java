...
class MovieResourceIT {
  ...
  @Test
  void findByIdShouldReturnUnauthorizedWhenNotValidToken() throws Exception {
  ...
  @Test
  void findByIdShouldReturnMovieAndReviewsWhenUserVisitorAuthenticated() throws Exception {
  ...
  @Test
  void findByIdShouldReturnMovieAndReviewsWhenMemberAuthenticated() throws Exception {
  ...
  @Test
  void findAllPagedShouldReturnUnauthorizedWhenNoTokenGiven() throws Exception {
    ResultActions result =
  ...
  @Test
  void findAllPagedShouldReturnOrderedPageWhenVisitorAuthenticated() throws Exception {
    String accessToken = obtainAccessToken(visitorUsername, visitorPassword);
  ...
  @Test
  void findAllPagedShouldReturnOrderedPageWhenMemberAuthenticated() throws Exception {
    String accessToken = obtainAccessToken(memberUsername, memberPassword);
  ...
  @Test
  void findAllPagedShouldReturnFilteredMoviesWhenGenreIsInformed() throws Exception {
    String accessToken = obtainAccessToken(visitorUsername, visitorPassword);
