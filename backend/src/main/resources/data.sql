-- Genres
INSERT INTO genre (name, create_moment, status)
...
-- Users
INSERT INTO user (name, email, password, create_moment, status)
...
-- MOVIES
-- Genero: Aventura
INSERT INTO movie (img_url, sub_title, synopsis, title, year, genre_id, create_moment, status)
